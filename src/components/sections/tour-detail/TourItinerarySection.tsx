  ...
  return (
    <section className="w-full overflow-hidden">
      <div className="uw-container uw-section pt-0">
        <Heading centered badge="Itinerario" title="Plan día a día" />
        <div className="relative mx-auto max-w-3xl">
          <div className="bg-border absolute top-0 bottom-0 left-6 w-0.5 sm:left-8" />
          <div className="flex flex-col gap-8">
            {tour.itinerary.map((day) => (
              <div key={day.day} className="relative flex gap-6 sm:gap-8">
                <div className="bg-primary font-heading text-primary-foreground relative z-10 flex size-12 shrink-0 items-center justify-center rounded-full text-lg sm:size-16 sm:text-xl">
                  {day.day}
                </div>
